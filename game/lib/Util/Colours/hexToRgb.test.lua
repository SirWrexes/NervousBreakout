...
describe("Util.colours", function()
    describe("hexToRgb", function()
        ...
        it("must fail when not getting hex", function()
            local data = "#sucepute"
            assert.error(callWith(data), ("Invalid hexadecimal sequence: `%s`."):format(data))
        end)

...
function getUnexpectedStateShapeWarningMessage(
  ...
  const argumentName = isAction(action, ActionTypes.INIT)
  ...
  if (typeof inputState !== 'object') {
    return (
      `The ${argumentName} has unexpected type of "${typeof inputState}". `
...
export default function combineReducers(reducers: {
  ...
  for (let key of reducerKeys) {
    if (typeof reducers[key] !== 'function') continue
  ...
  if (__DEV || __DEBUG) unexpectedKeyCache = {}
